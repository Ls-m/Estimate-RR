...
def generate_cwt_scalogram(ppg_segment, fs=125, target_shape=(128, 60), fmin=0.1, fmax=0.5, wavelet='morl', use_fake=False):
    """
...
def main(cfg: DictConfig):
    ...
    # # Collect all scalograms and labels
    # all_scalograms = []
    # all_rr = []
    # for subject_id, (ppg_segs, rr_segs, freq_segs, _) in processed_data.items():
    #     all_scalograms.extend(freq_segs)
    #     all_rr.extend(rr_segs)
