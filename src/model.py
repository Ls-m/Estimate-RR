...
class CNNLinearModel(nn.Module):
    def __init__(self, input_size=60*125, 
        ...
        self.model = nn.Sequential(
            nn.Conv1d(in_channels=1, out_channels=8, kernel_size=500, padding=0, stride=2),
            nn.BatchNorm1d(8),
            nn.ReLU(),
            nn.Conv1d(in_channels=8, out_channels=16, kernel_size=250, padding=0, stride=2),
            nn.BatchNorm1d(16),
            nn.ReLU(),
